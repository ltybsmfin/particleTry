...
public abstract class MagicSpriteBillboardParticle extends MagicBillboardParticle {
    protected Sprite sprite;

    protected MagicSpriteBillboardParticle(ClientWorld clientWorld, double d, double e, double f) {
        super(clientWorld, d, e, f);
    }

    protected MagicSpriteBillboardParticle(ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
