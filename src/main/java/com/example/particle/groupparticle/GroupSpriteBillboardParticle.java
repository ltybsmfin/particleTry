...
import com.example.particle.groupparticle.GroupBillboardParticle;
...
public abstract class GroupSpriteBillboardParticle extends GroupBillboardParticle {
    protected Sprite sprite;

    protected GroupSpriteBillboardParticle(ClientWorld clientWorld, double d, double e, double f) {
        super(clientWorld, d, e, f);
    }

    protected GroupSpriteBillboardParticle(ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
